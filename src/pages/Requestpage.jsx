  ...
  return (
    <div>
      <div className="p-4 max-w-screen mx-auto bg-[#18181b] ">
        <h1 className="text-[#d7d2cf] text-4xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mt-10 ml-2">
          Sent Request{" "}
        </h1>
        <form onSubmit={hundleSubmit}>
          ...
          <button className="w-full py-3 bg-[#d7d2cf] text-[#18181b] font-semibold rounded-xl 
                 hover:bg-[#bdb9b6] transition shadow-md mt-4.5">Sent</button>
        </form>
      </div>
      <Requestmovies />
    </div>
